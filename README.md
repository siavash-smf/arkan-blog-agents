...
| **کمپین چندکاناله** | یک تم | روایت مادر + مقاله + کاروسل + پست لینکدین |
...
یک تم → «روایت مادر» → سه کانال با زاویه‌ی اختصاصی هرکدام.
...
**۲. `allSettled` نه `all`.** شکست یک کانال نباید دو کانال دیگر را از بین ببرد.
